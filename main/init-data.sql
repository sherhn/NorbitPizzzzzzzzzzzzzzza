...
('Конструктор пиццы', 0.011111, 'pizza', '/constructor.avif', 'Создайте свою уникальную пиццу', '{"calories": 200, "protein": 10, "fat": 6, "carbohydrates": 25}', '["томатный соус", "моцарелла"]', '["ветчина", "пепперони", "курица", "грибы", "перец", "лук", "оливки", "ананасы", "кукуруза"]'),
