    ...
    if (favoriteProducts.length === 0) {
        favoritesContainer.innerHTML = `
            <div class="text-center py-16">
                <i class="far fa-heart text-8xl text-stone-700 mb-6"></i>
                <h3 class="text-3xl font-bold mb-4">В избранном пока пусто</h3>
                <p class="text-stone-400 text-lg mb-8">Добавляйте товары в избранное, чтобы не потерять</p>
...
function createFavoriteCard(product) {
    ...
    return `
        <div class="bg-card-bg rounded-2xl overflow-hidden border border-stone-800 hover:border-stone-600 transition-all duration-300 hover:shadow-xl group flex flex-col">
            <div class="h-48 bg-gradient-to-br from-stone-900 to-stone-800 flex items-center justify-center relative overflow-hidden">
                ...
                <button class="remove-from-favorites absolute top-3 right-3 w-10 h-10 bg-stone-900/80 hover:bg-stone-800 rounded-full flex items-center justify-center text-accent-red transition-all duration-300" data-product-id="${product.id}" title="Удалить из избранного">
            ...
            <div class="p-5 flex-grow flex flex-col">
                ...
                <div class="flex justify-between items-center mt-auto">
                    ...
                    <div class="flex space-x-2">
                        <button class="add-to-favorites w-10 h-10 rounded-full bg-stone-800 hover:bg-stone-700 flex items-center justify-center transition-all duration-300" data-product-id="${product.id}" title="В избранном">
...
function showFavoriteError() {
    ...
    if (favoritesContainer) {
        favoritesContainer.innerHTML = `
            <div class="text-center py-16">
                <i class="fas fa-exclamation-triangle text-8xl text-stone-700 mb-6"></i>
                <h3 class="text-3xl font-bold mb-4">Ошибка загрузки избранного</h3>
                <p class="text-stone-400 text-lg mb-8">Попробуйте обновить страницу</p>
